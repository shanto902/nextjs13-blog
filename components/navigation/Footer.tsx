  ...
  return (
    <div className=" pt-8 mt-10 border-t flex flex-col bg-base-100 relative z-10">
      <PaddingContainer>
        {/* Title Description */}
       <div>
       <div className=" grid lg:grid-cols-6 grid-cols-2 gap-5  py-3">
...
<OurPhotoZoom />
          ...
          <p className=" mt-4 grid grid-cols-9 col-span-2  w-fit space-y-2  text-sm">
              ...
              <span className=" col-span-2 font-bold">{dictionary.footer.email}</span>{" "}
              <span className=" text-center"> : </span>{" "}
              <span className=" col-span-6 text-left">
                sthapattyanonirman@gmail.com
              </span>
              <span className=" col-span-2 font-bold">{dictionary.footer.phone}</span>{" "}
              <span className=" text-center"> : </span>{" "}
              <span className=" col-span-6 text-left">
                {dictionary.footer.phoneNo}
              </span>
              <span className=" col-span-2 font-bold">{dictionary.footer.address}</span>{" "}
              <span className=" text-center"> : </span>{" "}
              <span className=" col-span-6 text-left">
