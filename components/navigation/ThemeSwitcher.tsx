    ...
    <div className="bg-primary border-neutral border-2 w-20 h-10 rounded-3xl flex items-center justify-around text-neutral">
      <button
       disabled={theme === "light" && true}
        onClick={toggleTheme}
        className={`${theme === "light" ? " cursor-default " : "cursor-pointer  bg-white text-black"} w-8 h-8 text-sm font-bold flex justify-center items-center  rounded-full p-1`}
      >
        <LightbulbIcon />
      </button>
      ...
      <button
        ...
        onClick={toggleTheme}
        className={`${theme === "dark" ? " cursor-default " : "cursor-pointer  bg-black text-white"}  w-8 h-8  text-sm font-bold flex justify-center items-center  rounded-full p-1`}
      >
        <MoonIcon />
      </button>
    </div>
